...
const cjs = require('@yourname/security-guard');
assert.equal(cjs.default.start().getStatus().lifecycle, 'unsupported');
cjs.default.stop();
assert.equal(typeof require('@yourname/security-guard/scoring').calculateScore, 'function');
assert.equal(typeof require('@yourname/security-guard/detectors').DimensionDetector, 'function');
