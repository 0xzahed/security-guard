...
const cjs = require('@0xzahed/security-guard');
assert.equal(cjs.default.start().getStatus().lifecycle, 'unsupported');
cjs.default.stop();
assert.equal(typeof require('@0xzahed/security-guard/scoring').calculateScore, 'function');
assert.equal(typeof require('@0xzahed/security-guard/detectors').DimensionDetector, 'function');
